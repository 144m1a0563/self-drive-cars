...
const highlights: Highlight[] = [
  {
    title: "Self Drive Cars in Tirupati",
    description:
      "Choose clean and well-maintained self drive cars in Tirupati for local travel, Tirumala trips, airport transfers and outstation journeys.",
    icon: <FaCarSide />,
  },
  {
    title: "Safe & Reliable Car Rentals",
    description:
      "Travel confidently with dependable rental cars, transparent support and vehicles prepared carefully before every booking.",
    icon: <FaShieldAlt />,
  },
  {
    title: "Affordable Rental Packages",
    description:
      "Flexible self drive car rental plans in Tirupati for families, business travellers, tourists and weekend trips.",
    icon: <FaUsers />,
  },
  {
    title: "24/7 Booking Support",
    description:
      "Contact Tiya Self Drive Cars anytime for availability, booking assistance, pickup support and vehicle information.",
    icon: <FaClock />,
  },
];
...
const benefits = [
  ...
  "Flexible 12-hour and 24-hour rental plans",
  "Self drive cars for Tirumala trips",
  "Renigunta Airport car rental support",
...
const AboutUs = () => {
  return (
    <section
      id="about"
      aria-labelledby="about-tiya-heading"
      ...
      <div className="container-custom relative z-10">
        ...
        <div className="grid grid-cols-1 items-center gap-10 lg:grid-cols-[48%_52%] lg:gap-14 xl:gap-20">
          ...
          >
            <div className="relative overflow-hidden rounded-[30px] bg-gray-100 shadow-[0_25px_70px_rgba(0,0,0,0.12)]">
              <img
                ...
                alt="Self drive cars in Tirupati by Tiya Self Drive Cars"
                loading="lazy"
                width="1400"
                height="900"
              ...
              <div className="absolute bottom-6 left-6 right-6 rounded-[22px] border border-white/20 bg-white/90 p-5 backdrop-blur-md sm:bottom-8 sm:left-8 sm:right-8 sm:p-6">
                <p className="text-[10px] font-bold uppercase tracking-[3px] text-red-600">
                  Trusted Self Drive Service in Tirupati
                </p>

                <h3 className="mt-2 text-[21px] font-bold leading-tight text-gray-950 sm:text-[26px]">
                  Freedom to travel Tirupati and beyond on your own terms
                </h3>
              </div>
            </div>
          ...
          >
            ...
            <h2
              id="about-tiya-heading"
              className="mt-4 text-[34px] font-extrabold leading-[1.1] tracking-[-1.5px] text-gray-950 sm:text-[46px] lg:text-[56px]"
            >
            ...
            <p className="mt-6 text-[13px] leading-7 text-gray-600 sm:text-[15px]">
              ...
              ? Tiya Self Drive Cars offers clean and well-maintained hatchbacks,
              sedans, SUVs and family cars with flexible rental packages for
              local travel, family trips, business journeys and weekend travel.
            </p>

            <p className="mt-4 text-[13px] leading-7 text-gray-600 sm:text-[15px]">
              Our{" "}
              <strong className="font-semibold text-gray-900">
                car rental service in Tirupati
              </strong>{" "}
              is suitable for Tirumala trips, Renigunta Airport travel, local
              sightseeing and outstation journeys. Enjoy privacy, comfort and
              complete freedom to travel at your own pace.
            </p>

            <p className="mt-4 text-[13px] leading-7 text-gray-600 sm:text-[15px]">
              Whether you need a short-term{" "}
              <strong className="font-semibold text-gray-900">
                self drive car rental in Tirupati
              </strong>{" "}
              or a vehicle for a full-day journey, our team helps you choose the
              right car based on your travel plan and budget.
            </p>
            ...
            <div className="mt-8 flex flex-col gap-3 sm:flex-row">
              <Link
                to="/cars"
                aria-label="View self drive cars available in Tirupati"
              ...
              <a
                ...
                aria-label="Call Tiya Self Drive Cars in Tirupati"
        ...
        >
          <div className="mx-auto max-w-[850px] text-center">
            <p className="text-[11px] font-bold uppercase tracking-[4px] text-red-600">
              Popular Travel Options
            </p>

            <h2 className="mt-4 text-[30px] font-extrabold leading-tight text-gray-950 sm:text-[40px]">
              Self Drive Car Rentals Around Tirupati
            </h2>

            <p className="mx-auto mt-4 max-w-[700px] text-[13px] leading-7 text-gray-500 sm:text-[14px]">
              Book a self drive car for Tirupati city travel, Tirumala visits,
              Renigunta Airport pickup or outstation journeys across Andhra
              Pradesh.
            </p>
          </div>

          <div className="mt-9 grid grid-cols-1 gap-5 md:grid-cols-3">
            <article className="rounded-[24px] border border-gray-100 bg-white p-6 shadow-[0_16px_50px_rgba(0,0,0,0.05)]">
              <span className="flex h-14 w-14 items-center justify-center rounded-2xl bg-red-50 text-[22px] text-red-600">
                <FaMapMarkerAlt />
              </span>

              <h3 className="mt-5 text-[19px] font-bold text-gray-950">
                Self Drive Cars in Tirupati
              </h3>

              <p className="mt-3 text-[12px] leading-6 text-gray-500">
                Convenient self drive car rentals for local sightseeing,
                shopping, business travel and personal trips across Tirupati.
              </p>
            </article>
            ...
            <article className="rounded-[24px] border border-gray-100 bg-white p-6 shadow-[0_16px_50px_rgba(0,0,0,0.05)]">
              ...
              <h3 className="mt-5 text-[19px] font-bold text-gray-950">
                Cars for Tirumala Trips
              </h3>

              <p className="mt-3 text-[12px] leading-6 text-gray-500">
                Choose a comfortable rental car for Tirumala visits and temple
                travel from Tirupati.
              </p>
            </article>
            ...
            <article className="rounded-[24px] border border-gray-100 bg-white p-6 shadow-[0_16px_50px_rgba(0,0,0,0.05)]">
              ...
              <h3 className="mt-5 text-[19px] font-bold text-gray-950">
                Renigunta Airport Car Rental
              </h3>

              <p className="mt-3 text-[12px] leading-6 text-gray-500">
                Book self drive cars for convenient airport pickup, drop and
                onward travel from Renigunta Airport.
              </p>
            </article>
          </div>
        </motion.div>
        ...
        <div className="mt-12 grid grid-cols-1 gap-6 lg:mt-14 lg:grid-cols-2">
          ...
          >
            ...
            <p className="mt-3 text-[13px] leading-7 text-gray-600">
              To provide safe, clean and affordable self drive cars in Tirupati
              with flexible rental packages, a simple booking process and
          ...
          >
            ...
            <p className="mt-3 text-[13px] leading-7 text-white/60">
              Every customer receives transparent rental information,
              responsive support and a well-prepared vehicle for a comfortable
              journey in Tirupati and beyond.
            </p>
          </motion.div>
        </div>
      </div>
